...
<body>
    ...
    <header>
        ...
        <div id="isiHeader">
            ...
            <div id="gridHeader">
                <button onclick="window.location='bundle.php?page=dashboard';" <?php if ($page) {if ($_GET['page'] == "" || $_GET['page'] == "dashboard" || $_GET['page'] == "edituser") {echo 'id="selected"';}} else echo 'id="selected"'; ?>>
                ...
                <button onclick="window.location='bundle.php?page=grafik';" <?php if ($page) if ($_GET['page'] == "grafik") echo 'id="selected"' ?>>
                ...
                <button onclick="window.location='bundle.php?page=akunadmin';" <?php if ($page) if ($_GET['page'] == "editadmin" || $_GET['page'] == "akunadmin") echo 'id="selected"' ?>>
                ...
                <button onclick="window.location='bundle.php?page=platnomor';" <?php if ($page) if ($_GET['page'] == "platnomor") echo 'id="selected"' ?>>
    ...
    <div><nav>
        ...
        <form class="form-search" >
            <input type="hidden" name="page" value="<?php if ($page) echo $_GET['page'] ?>">
            <label for="search">
